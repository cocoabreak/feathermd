...
<p align="center">
  <img src="app/src-tauri/icons/icon-source.png" alt="Hiranoaロゴ" width="180">
</p>
...
<p align="center">
  <img src="docs/images/hiranoa-overview.png" alt="フォルダー内のMarkdown文書を閲覧するHiranoa" width="1000">
</p>
...
- **ナビゲーション** — 見出しから生成する目次、Wikiリンク（`[[ページ名]]`）、リンク先ホバープレビュー、リンクインスペクターと独立表示できるローカルリンクグラフ、ローカルMarkdownリンク、戻る／進む履歴、見出しアンカー、タブごとのスクロール位置保持。
